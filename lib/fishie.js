...
Fishie.schedulePrivateLesson = function (lessonObj, setID) {
	...
	if (shareLessons.length > 0) {
		Fishie.setSharedPrivate(shareLessons[0], lessonObj);
	} else {
		Fishie.scheduleLesson(lessonObj, setID);
	}
}
Fishie.setSharedPrivate = function (origLesson, linkedLesson) {
	Meteor.call('setSharedPrivate', origLesson, linkedLesson);
}
