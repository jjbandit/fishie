...
// Fishie.getBreakTimeBlocks = function(firstLesson, secondLesson) {
// 	// Pass this method two lesson objects
// 	// It returns an array populated with the starting time of each 15 minute block
// 	// between the two lessons by computing the end/start times of the lessons and
// 	// passing those to Fishie.getTimeBlocks()
// 	// console.log(firstLesson, lastLesson);
// 	var firstLessonEndTime = firstLesson.lessonTime[firstLesson.lessonTime.length - 1];
// 	var secondLessonStartTime = secondLesson.lessonTime[0];
// 	// console.log(firstLessonEndTime, lastLessonStartTime);
// 	var r = Fishie.getTimeBlocks(firstLessonEndTime, secondLessonStartTime);
// 	// console.log(r);
// 	return r;
// }
